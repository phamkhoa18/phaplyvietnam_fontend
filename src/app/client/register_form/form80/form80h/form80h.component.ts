...
@Component({
  selector: 'app-form80h',
  templateUrl: './form80h.component.html',
  styleUrls: ['./form80h.component.scss'],
  providers: [MessageService , ConfirmationService]
})
export class Form80hComponent {
  ...
  thongtinarray:any = [] ;
  itemthongtin: any = {} ;
  sectionGroupContainer: string = 'sectionH'
  public entries:any = [];
  constructor(
